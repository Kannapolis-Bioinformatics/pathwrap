...
## Phenofile structure
Simply create a phenofile with information about the location of raw files and
class and run the wrapper function pathviewwrap. An example of how phenofile can
be created is as below.
```{r wrapper, eval =TRUE}
#library(pathviewwrap)
...
FileName <- list.files(file.path(system.file(
    package = "pathviewwrap"), "extdata"), full.names = T, pattern = "fastq.gz")
...
cat(paste(readLines(system.file(package = "pathviewwrap",
...
`sample1`    | `/Library/Frameworks/R.framework/Versions/4.3-x86_64/Resources/library/pathviewwrap/extdata/sample1_sub.fastq.gz` | `A`
`sample3`    | `/Library/Frameworks/R.framework/Versions/4.3-x86_64/Resources/library/pathviewwrap/extdata/sample3_sub.fastq.gz` | `B`
`sample5`    | `/Library/Frameworks/R.framework/Versions/4.3-x86_64/Resources/library/pathviewwrap/extdata/sample5_sub.fastq.gz` | `A`
`sample6`    | `/Library/Frameworks/R.framework/Versions/4.3-x86_64/Resources/library/pathviewwrap/extdata/sample6_sub.fastq.gz` | `B`
-->
