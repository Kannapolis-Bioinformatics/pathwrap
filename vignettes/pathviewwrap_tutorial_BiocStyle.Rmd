...
Install the pacakge using BiocManager

```{r install reference packages, eval = FALSE}
...
To plot compound data as well using pathwrap 
```{r combined_run, eval=FALSE}
#which column has refererence sample and which has experiment
csamp <- c(1,2)
cref <- c(3,4)
#provide path to compound data
